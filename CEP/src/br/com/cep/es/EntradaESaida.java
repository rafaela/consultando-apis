...
public class EntradaESaida {
	 ...
	 * 
	 * @return os valores <code>YES_OPTION</code>, <code>NO_OPTION</code> ou <code>CLOSED_OPTION</code>,
	 * respectivamente, se o usuário responder
	 ...
	 */
	public static void exibirTabela(String titulo, Object[][] linhas, String[] colunas,
			int[] larguraColuna, int[] alinhamentoColuna, int larguraTabela, int alturaTabela) {
	 	...
	 	if (larguraColuna != null)
	 		 // A largura das colunas é definido de acordo com os valores do array larguraColuna.
	 		for (int coluna = 0; coluna < larguraColuna.length; coluna++)
	 			table.getColumnModel().getColumn(coluna).setPreferredWidth(larguraColuna[coluna]);
	 	else
	 		// A largura das colunas é definido de acordo com a largura da área de exibição da tabela.
	...
	public static void exibirTexto(String texto, String titulo) {
		//Cria uma área de texto para armazenar o texto a ser exibido.
		JTextArea textArea = new JTextArea(10, 20);
		
		//Define a área de texto como não editável.
		textArea.setEditable(false);
		
		//Define a quebra automática das linhas de texto
		textArea.setLineWrap(true);
		
		//Define a quebra automática das linhas de texto ocorra entre palavras
